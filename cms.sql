...
-- Дамп данных таблицы cms.loc.ActionLog: 25 rows
...
INSERT INTO `ActionLog` (`id`, `username`, `event`, `model_name`, `model_title`, `datetime`) VALUES
	...
	(19, 'admin', 1, 'StoreAttribute', 'ves', '2015-12-12 16:43:37'),
	(20, 'admin', 2, 'StoreProductType', 'Акустика', '2015-12-12 16:43:47'),
	(21, 'admin', 2, 'StoreAttribute', 'ves', '2015-12-12 16:44:18'),
	(22, 'admin', 2, 'StoreAttribute', 'ves', '2015-12-12 16:45:07'),
	(23, 'admin', 2, 'StoreAttribute', 'ves', '2015-12-12 16:45:41'),
	(24, 'admin', 2, 'StoreAttribute', 'ves', '2015-12-12 16:46:31'),
	(25, 'admin', 2, 'StoreProductType', 'Акустика', '2015-12-12 16:47:09');
...
-- Дамп данных таблицы cms.loc.Order: 1 rows
DELETE FROM `Order`;
...
INSERT INTO `Order` (`id`, `user_id`, `secret_key`, `delivery_id`, `delivery_price`, `total_price`, `status_id`, `paid`, `user_name`, `user_email`, `user_address`, `user_phone`, `user_comment`, `ip_address`, `created`, `updated`, `discount`, `admin_comment`) VALUES
	(1, NULL, 'mexkrnkeez', 15, 0.00, 425.00, 1, NULL, 'тимур', 'tyama92@mail.ru', '', '', '', '127.0.0.1', '2015-12-15 16:08:54', '2015-12-15 16:08:54', NULL, NULL);
...
-- Дамп данных таблицы cms.loc.OrderProduct: 1 rows
...
INSERT INTO `OrderProduct` (`id`, `order_id`, `product_id`, `configurable_id`, `name`, `configurable_name`, `configurable_data`, `variants`, `quantity`, `sku`, `price`) VALUES
	(88, 1, 36, 0, 'Nokia N9', NULL, NULL, NULL, 1, NULL, 425.00);
...
-- Дамп данных таблицы cms.loc.StoreAttribute: 20 rows
...
-- Дамп данных таблицы cms.loc.StoreAttributeOption: 80 rows
...
-- Дамп данных таблицы cms.loc.StoreAttributeOptionTranslate: 160 rows
...
-- Дамп данных таблицы cms.loc.StoreAttributeTranslate: 40 rows
...
-- Дамп данных таблицы cms.loc.StoreProductAttributeEAV: 188 rows
...
-- Дамп данных таблицы cms.loc.StoreTypeAttribute: 22 rows
...
-- Дамп данных таблицы cms.loc.StoreWishlist: 1 rows
...
-- Дамп данных таблицы cms.loc.StoreWishlistProducts: 3 rows
...
-- Дамп данных таблицы cms.loc.SystemLayouts: ~3 rows (приблизительно)
...
INSERT INTO `user` (`id`, `username`, `password`, `email`, `created_at`, `last_login`, `login_ip`, `recovery_key`, `recovery_password`, `discount`, `banned`) VALUES
	(1, 'admin', 'd033e22ae348aeb5660fc2140aec35850c4da997', 'admin@mail.ru', '2015-03-25 12:44:10', '2016-02-16 16:34:46', '127.0.0.1', NULL, NULL, NULL, 0);
