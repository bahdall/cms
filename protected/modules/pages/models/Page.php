...
Yii::import('application.modules.pages.models.PageImage');
Yii::import('application.modules.pages.models.components.PageImageSaver');
/**
...
class Page extends BaseModel
{
    ...
    {
        return array(
            'images'          => array(self::HAS_MANY, 'PageImage', 'page_id'),
            'mainImage'       => array(self::HAS_ONE, 'PageImage', 'page_id', 'condition'=>'is_main=1'),
            'imagesNoMain'    => array(self::HAS_MANY, 'PageImage', 'page_id', 'condition'=>'is_main=0'),
